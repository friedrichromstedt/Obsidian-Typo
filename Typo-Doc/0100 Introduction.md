...
1. *Editing mode*, here the markdown text can be edited while it is already HTML-converted;
...
1. In editing mode, it seems to be agreed upon that headlines feature whitespace only at the top side. I also most often felt dissatisfied with the whitespace rendering around headings in reading mode.
